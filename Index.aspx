...
<head>
    ...
    <style>
        .projects-area .project-item__thumbnail {
            width: 100%;
            aspect-ratio: 4 / 3;
            overflow: hidden;
            background: #f4f6fa;
        ...
        .projects-area .project-item__thumbnail img {
            width: 100%;
            height: 100%;
            object-fit: cover;
            display: block;
                        ...
                        <ul>    <!-- SLIDE  -->
                            <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/img/slider/slider01_2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                ...
                                <div class="tp-caption tp-resizeme font-weight-900" 
                                     id="slide-1-layer-1" 
                                     data-x="['left','left','left','left']" data-hoffset="['350','195','100','38']" 
                                     data-y="['top','top','top','top']" data-voffset="['150','165','150','135']" 
                                    data-fontsize="['52','46','38','28']"
                                    data-lineheight="['56','50','42','32']"
                                    data-width="['470','450','390','280']"
                                    data-height="none"
                                    ...
                                    style="z-index: 5; width: 470px; white-space: normal; font-size: 52px; line-height: 56px; font-weight: 900; color: rgba(46,50,56,1); font-family: Roboto; text-transform: none;">
                                    <span style="color: rgba(206,160,74,1);">Empowering</span><br/>
                                    <span style="color: rgba(206,160,74,1);">Communities</span> Through<br/>
                            ...
                            <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/img/slider/slider01_3.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                ...
                                <div class="tp-caption tp-resizeme font-weight-900" 
                                     id="slide-2-layer-1" 
                                     data-x="['left','left','left','left']" data-hoffset="['400','255','136','66']" 
                                     data-y="['top','top','top','top']" data-voffset="['54','56','38','28']" 
                                    data-fontsize="['52','46','38','28']"
                                    data-lineheight="['56','50','42','32']"
                                    data-width="['760','620','440','280']"
                                    data-height="none"
                                    data-whitespace="normal"
                                    ...
                                    style="z-index: 10; width: 760px; white-space: normal; font-size: 52px; line-height: 56px; font-weight: 900; color: rgba(255,255,255,1); font-family: Roboto; text-transform: uppercase;">
                                    TURN ON THE <span style="color: rgba(33,166,76,1);">GREEN LIGHT</span><br/>
                                    FOR DRIVING MOBILITY AND<br/>
                                    OPPORTUNITY.
                                </div>
                            </li>
                            <!-- SLIDE  -->
                            <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/img/slider/slider01_4.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                ...
                                <div class="tp-caption tp-resizeme font-weight-900" 
                                     ...
                                     data-y="['top','top','top','top']" data-voffset="['285','295','275','225']" 
                                    data-fontsize="['52','46','38','28']"
                                    data-lineheight="['56','50','42','32']"
                                    data-width="['860','700','520','320']"
                                    data-height="none"
                                    data-whitespace="normal"
                                    ...
                                    style="z-index: 14; width: 860px; white-space: normal; font-size: 52px; line-height: 56px; font-weight: 900; color: rgba(220,188,103,1);font-family:Roboto;text-transform:uppercase;">VALUING PEOPLE SECURING<br/>FUTURE AND RETURNING<br/>GOLD MEMORIES<br/>WITH EXCELLENCE</div>
